            ...
            <div class="card-body">
                <form action="{{ route('vendors.update', $vendor->id) }}" method="post">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control @error('contact_number') is-invalid @enderror" id="contact_number" name="contact_number" value="{{ old('contact_number', $vendor->contact_number) }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control @error('completed_redirect_url') is-invalid @enderror" id="completed_redirect_url" name="completed_redirect_url" value="{{ old('completed_redirect_url', $vendor->completed_redirect_url) }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control @error('terminated_redirect_url') is-invalid @enderror" id="terminated_redirect_url" name="terminated_redirect_url" value="{{ old('terminated_redirect_url', $vendor->terminated_redirect_url) }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control @error('quote_full_redirect_url') is-invalid @enderror" id="quote_full_redirect_url" name="quote_full_redirect_url" value="{{ old('quote_full_redirect_url', $vendor->quote_full_redirect_url) }}">
                    ...
                    <div class="mb-3 row">
                        <input type="submit" class="col-md-3 offset-md-5 btn btn-success" value="Update Vendor">
                    </div>
